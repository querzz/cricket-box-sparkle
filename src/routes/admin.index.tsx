...
function AdminDashboard() {
  ...
  function scrollToSection(id: string) {
    ...
    if (!target) return;
    const y = Math.max(0, target.getBoundingClientRect().top + window.scrollY - 20);
