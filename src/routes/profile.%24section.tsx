    ...
    <AppShell title={title} back="/profile">
      {section === "leaderboard" && (
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-2 px-1 text-[10px] text-muted-foreground"><Trophy className="size-3.5 text-primary" /> Рейтинг обновляется после завершённых действий.</div>
        </div>
      )}
